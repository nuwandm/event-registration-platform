    ...
    <div className="min-h-screen flex flex-col bg-slate-50">
      ...
      <footer className="bg-white border-t border-slate-200 py-6 text-center text-sm text-slate-500">
        ...
        <span className="relative inline-block group">
          <span className="font-semibold text-blue-600 cursor-pointer">DreamLabs IT Solution</span>
          <span className="absolute bottom-full left-1/2 -translate-x-1/2 mb-2 hidden group-hover:flex items-center gap-2 bg-slate-800 text-white text-xs font-medium px-3 py-2 rounded-lg shadow-lg whitespace-nowrap z-50">
