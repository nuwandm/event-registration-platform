    ...
    <div className="max-w-2xl mx-auto px-4 py-8 pb-28">
      ...
      {event.whatsappNumber && (
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="fixed bottom-6 right-4 z-50 flex items-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white px-3 py-3 sm:px-4 rounded-full shadow-lg hover:shadow-xl transition-all duration-200 font-semibold text-sm"
