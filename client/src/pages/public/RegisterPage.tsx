...
export function RegisterPage() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      ...
      {/* Contact info banner */}
      {(event.contactPhone || event.whatsappNumber) && (
        <div className="mb-5 flex items-start gap-3 bg-blue-50 border border-blue-100 rounded-xl px-4 py-3">
          <Phone className="w-4 h-4 mt-0.5 shrink-0" style={{ color: brand }} />
            ...
            <div className="flex flex-wrap gap-3">
              {event.contactPhone && (
                <a
                  ...
                  className="flex items-center gap-1.5 text-sm text-slate-700 hover:text-blue-600 transition-colors"
                >
              ...
              {event.whatsappNumber && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-1.5 text-sm text-emerald-700 hover:text-emerald-600 transition-colors"
                >
